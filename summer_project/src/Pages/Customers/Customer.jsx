    ...
    <div>
      ...
      <div className='ml-64 mt-16 py-3'>
          ...
          <header className="flex justify-between items-center font-bold bg-white pl-8 px-2 py-4 mb-4 border-b border-gray-200 ">
            ...
            <Link to="/customer/add" ><Button color="primary" variant="ghost">Add new customer</Button></Link>
          </header>
        ...
        <div className=' shadow-xl hover:bg-opacity-90 rounded-xl  flex justify-between items-center  px-4 py-2 ml-6 mr-16 '>
          ...
          <Link to="/customer/edit"><button className="flex p-2.5 bg-teal-500 hover:bg-teal-700 rounded-xl hover:rounded-3xl  transition-all duration-300 text-white">
