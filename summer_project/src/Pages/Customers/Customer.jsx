    ...
    <div>
      ...
      <div className='ml-64 mt-16 py-3'>
          ...
          <header className="flex justify-between items-center bg-white text-black text-3xl font-bold pl-8 px-2 py-4 mb-8 border-b border-gray-200 ">
            <h2>Customers</h2>
            <Link to="/customer/add" ><button className='bg-blue-600 text-white text-xl no-underline py-2 px-4 rounded-custom cursor-pointer'>Add new customer</button></Link>
        ...
        <div className=' border-b rounded-xl border-gray-700 flex justify-between items-center  px-4 py-2 ml-6 mr-16'>
          ...
          <Link to="/customer/detail"><button className='bg-green-600 text-white text-xl no-underline py-2 px-4 rounded-custom cursor-pointer '>Detail</button></Link>
        </div>
